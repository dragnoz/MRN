...
exports.isDialogueFile = isDialogueFile;
exports.findLanguageFolderUri = findLanguageFolderUri;
exports.findAvailableLanguages = findAvailableLanguages;
exports.findLanguageFileUri = findLanguageFileUri;
exports.getDefaultLanguageFileUri = getDefaultLanguageFileUri;
exports.openLanguageFileBeside = openLanguageFileBeside;
exports.findAdjacentLangEditor = findAdjacentLangEditor;
// Helper functions for dialogue and language file interactions
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
// --- Configuration Accessors ---
function getLanguageFolderName() {
    return vscode.workspace.getConfiguration('mrt.dialogue').get('languageFolderName', 'texts');
}
function getDefaultLanguageCode() {
    return vscode.workspace.getConfiguration('mrt.dialogue').get('defaultLanguage', 'en_US');
}
 ...
 */
async function findLanguageFolderUri(dialogueFileUri) {
 ...
 */
async function findAvailableLanguages(langFolderUri) {
    if (!langFolderUri) {
        return [];
    }
    try {
 ...
 */
async function findLanguageFileUri(langFolderUri, langCode) {
 ...
 */
async function getDefaultLanguageFileUri(langFolderUri) {
 ...
 */
async function openLanguageFileBeside(langFileUri) {
    if (!langFileUri) {
 ...
 */
function findAdjacentLangEditor() {
...
//# sourceMappingURL=dialogueHelper.js.map